...
if(isset($_POST['fixphone'])){
    if($_POST['fixphone'] == null ) {
}else{ 
$pdf->Cell(30,10,utf8_decode('Téléphone Fix :'),0, 0, 'L');
$pdf->Cell(80,10,utf8_decode($_POST['fixphone']),0, 1, 'C');
} }
$pdf->Cell(30,10,utf8_decode('Email : '),0, 0, 'L');
$pdf->Cell(80,10,utf8_decode($_POST['email']),0, 1, 'C');
$pdf->Cell(30,10,utf8_decode('Diplôme : '),0, 0, 'L');
$pdf->Cell(80,10,utf8_decode($_POST['dip']),0, 1, 'C');
$pdf->Cell(30,10,utf8_decode('Année d\'obtention ?'),0, 0, 'L');
$pdf->Cell(80,10,utf8_decode($_POST['anne']),0, 1, 'C');
$pdf->Cell(30,10,utf8_decode('État civil : '),0, 0, 'L');
$pdf->Cell(80,10,utf8_decode($_POST['selectMenu']),0, 1, 'C');
$pdf->Cell(30,10,utf8_decode('Type de Diplôme :'),0, 0, 'L');
$pdf->Cell(80,10,utf8_decode($_POST['formdiplome']),0, 1, 'C');
$pdf->Cell(30,10,utf8_decode('Fonction de Pére :'),0, 0, 'L');
$pdf->Cell(80,10,utf8_decode($_POST['pere']),0, 1, 'C');
$pdf->Cell(30,10,utf8_decode('Fonction de Mére :'),0, 0, 'L');
$pdf->Cell(80,10,utf8_decode($_POST['mere']),0, 1, 'C');
$pdf->Cell(30,10,utf8_decode('Les moyens pour payer vos études:'),0, 0, 'L');
$pdf->Cell(80,10,utf8_decode($_POST['formmoyens']),0, 1, 'C');
...
$pdfdoc = $pdf->Output('', 'S');
       ...
       if ($mail->addReplyTo($_POST['email'], $_POST['nom'])) {
        $mail->Subject = 'Formulaire Etudiant'; 
   ...
   //Send the message, check for errors
        if (!$mail->send()) {
            ...
            header("Refresh:5; url=formetud.php");	
                                        ...
                                        <form  method="POST" action="" id="myForm">
                                            <div class="f-row">
                                                <div class="one-half">
                                                    ...
                                                    <input type="text" id="nom" name="nom" class="validate" placeholder="Votre Nom svp" required>
                                                </div>
                                                <div class="one-half">
                                                    <label >Prénom : <span style="color: red;">(*)</span></label>
                                                    <input type="text" id="prenom" name="prenom" class="validate" placeholder="Votre Prénom svp" required>
                                                </div>
                                            </div>
                                            <div class="f-row">
                                                <div class="one-half"> 
                                                    <label >Âge : <span style="color: red;">(*)</span></label>
                                                        <input type="number" id="age" class="validate" name="age" placeholder="Votre Âge svp" required  min="18" max="100" value="18">
                                                </div>
                                                <div class="one-half">
                                                    <label>Email Id: <span style="color: red;">(*)</span></label>
                                                        <input type="email" name="email" id="email" class="validate" placeholder="Votre Email svp" required>
                                                </div>
                                            </div>     
                                            <div class="f-row">
                                                <div class="one-half">
                                                    <label>Téléphone Mobile: <span style="color: red;">(*)</span></label><br>
                                                    <input id="phone" name="phone" class="validate" type="tel">
                                                </div>
                                                <div class="one-half">
                                                    <label>Téléphone Fix : <span style="color: red;">(*)</span></label><br>
                                                    <input id="fixphone" name="fixphone" class="validate" type="tel">
                                                </div>
                                            </div>
                                            <div class="f-row">
                                                <div class="one-half">           
                                                    <label >Diplôme : <span style="color: red;">(*)</span></label>
                                                    <input type="text" name="dip" id="dip" class="validate" placeholder="Votre Diplôme svp" required>
                                                </div>
                                                <div class="one-half">
                                                    <label >Année d'obtention ? <span style="color: red;">(*)</span></label>
                                                    <input type="number" name="anne" class="validate" id="anne"  placeholder="2020 (par exemple)" required>
                                                </div>
                                            </div>
                                            <div class="f-row">
                                                <div class="one-half">
                                                    <label>État civil : <span style="color: red;">(*)</span></label>
                                                    <select name="selectMenu" id="selectMenu" class="validate">
                                                ...
                                                <div class="one-half">
                                                    <label>Type de Diplôme : <span style="color: red;">(*)</span></label><br>
                                                    <input name="formdiplome" type="radio" value=" Privé " id="diplome0">
                                                        <label for="diplome0">  Privé </label>
                                                    <input name="formdiplome" type="radio" value=" Public " id="diplome1">
                                                        <label for="diplome1">  Public </label>
                                                </div> 
                                            </div>
                                            <div class="f-row">
                                                <p style="font-weight: bold;text-align: center;font-size: 14px;">Fonctions des parents :</p>
                                                <div class="one-half">          
                                                    <label >Pére : <span style="color: red;">(*)</span></label>
                                                    <input type="text" name="pere" class="validate" id="pere"  placeholder="" required>
                                                </div>
                                                <div class="one-half">
                                                    <label >Mére : <span style="color: red;">(*)</span></label>
                                                    <input type="text" name="mere" class="validate" id="mere" placeholder="" required>
                                                </div>
                                            </div>
                                            <div class="f-row">
                                                <p style="padding-left: 10px;" >Avez-vous les moyens pour payer vos études au Canada? <span style="color: red;">(*)</span></p>
                                                <div class="one-half">
                                                    <input name="formmoyens" type="radio" value=" Oui " id="moyens0">
                                                        <label for="moyens0">  Oui </label>
                                                    <input name="formmoyens" type="radio" value=" Non " id="moyens1">
                                                        <label for="moyens1">  Non </label>
                                                </div> 
                                            </div>
                                            <div class="f-row">
                                                <div class="one-half">
                                                    <label>Message : </label>
                                                    <textarea placeholder="Votre Email svp" name="message" id="message"></textarea>
                                                </div>
                                            </div>
