   ...
   class myPDF extends fPDF
{
	function header()
	{
		...
		$this->Cell(276,5,'Formulaire de Gens d\'affaire',0,0,'C'); 
		$this->Ln(30);
	}
	function footer(){
		$this->SetY(-15);
...
$pdf->Cell(30,10,utf8_decode('Telephone : '),0, 0, 'L');
...
try {
   ...
   $mail->addAddress("bestcanadaim@hotmail.com");
       if ($mail->addReplyTo($email,$nom)) {
        $mail->Subject = 'Formulaire Gens d\'affire'; 
   ...
   //Send the message, check for errors
        if (!$mail->send()) {
            ...
            header("Refresh:5; url=formgens.php");	
                                        ...
                                        <form  method="POST" action="formegens_message.php" id="myForm">
                                            ...
                                            <div class="f-row">
                                                ...
                                                <div class="one-half">
                                                    ...
                                                    <input name="form[sexe]" type="radio" value="  Homme " id="sexe0">
                                                        <label for="sexe0">  Homme </label>
                                                    <input name="form[sexe]" type="radio" value="  Femme " id="sexe1">
