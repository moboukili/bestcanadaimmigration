                    ...
                    <div class="sb2-2-2">
                        ...
                        <div class="row">
                            ...
                            <div class="box-inn-sp admin-form">
                                    <div class="inn-title">
                                        <h4>Formulaire gens d'affaire</h4>
                                    </div>
                                    <div class="tab-inn">
                                        <form  method="POST" action="formegens_message.php" id="myForm">
                                            <div class="f-row">
                                                <div class="one-half">
                                                    <label >Nom : <span style="color: red;">(*)</span></label>
                                                    <input type="text" name="nom" id="nom" class="validate" placeholder="Votre Nom svp" required>
                                                </div>
                                                <div class="one-half">
                                                    <label >Prénom : <span style="color: red;">(*)</span></label>
                                                    <input type="text" name="prenom" id="prenom" class="validate" placeholder="Votre Prénom svp" required>
                                                </div>
                                            </div>
                                            <div class="f-row">
                                                <div class="one-half"> 
                                                    <label >Âge : <span style="color: red;">(*)</span></label>
                                                        <input type="number" name="age" id="age" placeholder="Votre Âge svp" class="validate" required min="18" max="100" value="18"> 
                                                </div>
                                                <div class="one-half">
                                                    <label>Sexe : <span style="color: red;">(*)</span></label><br>
                                                    <input name="formsexe" type="radio" value=" Homme " id="sexe0" required >
                                            ...
                                            <div class="f-row">
                                                <div class="one-half">
                                                    ...
                                                    <input id="phone" name="phone" class="validate" type="tel" required>
                                                </div>
                                                <div class="one-half">
                                            ...
                                            <div class="f-row">
                                                ...
                                                <div class="one-half">
                                                        ...
                                                        <div id="Marié">
                                                            ...
                                                            <input name="Marie" type="radio" value="  Oui " id="Marie0" >
                                                            <label for="Marie0">  Oui </label>
                                                            <input name="Marie" type="radio" value="  Non " id="Marie1" >
                                                            <label for="Marie1">  Non </label>
                                                        </div>
                                                        ...
                                                        <div id="Divorcé(e)">
                                                            <label>Avez-vous des enfants ? <span style="color: red;">(*)</span></label><br>
                                                            <input name="Divorce" type="radio" value=" Oui " id="Divorce0" >
                                                            <label for="Divorce0">  Oui </label>
                                                            <input name="Divorce" type="radio" value=" Non " id="Divorce1">
                                                            <label for="Divorce1">  Non </label>
                                                        </div>

                                                        <div id="Veuf(e)">
                                                            <label>Avez-vous des enfants ? <span style="color: red;">(*)</span></label><br>
                                                            <input name="Veuf" type="radio" value="  Oui " id="Veuf0" >
                                                            <label for="Veuf0">  Oui </label>
                                                            <input name="Veuf" type="radio" value="  Non " id="Veuf1">
                                                            <label for="Veuf1">  Non </label>
                                                        </div>
                                                </div>
                                            </div>        
                                            <div class="f-row">
